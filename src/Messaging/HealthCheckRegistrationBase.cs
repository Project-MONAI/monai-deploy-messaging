...
namespace Monai.Deploy.Messaging
{
    ...
    {
        protected SubscriberServiceHealthCheckRegistrationBase(string fullyQualifiedAssemblyName) : base(fullyQualifiedAssemblyName)
        {
        }
    }
    ...
    {
        protected PublisherServiceHealthCheckRegistrationBase(string fullyQualifiedAssemblyName) : base(fullyQualifiedAssemblyName)
        {
        }
    }
